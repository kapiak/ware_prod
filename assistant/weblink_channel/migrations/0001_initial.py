# Generated by Django 3.1 on 2020-08-18 02:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.CharField(help_text='Auto Generated order number', max_length=100, verbose_name='Number')),
                ('address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='addresses.address')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_weblink_channel_weblinkorder', to=settings.AUTH_USER_MODEL)),
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='weblink_orders', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_weblink_channel_weblinkorder', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Web Link Order',
                'verbose_name_plural': 'Web Link Orders',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_weblink_channel_weblinkorderitem', to=settings.AUTH_USER_MODEL)),
                ('order', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='weblink_channel.weblinkorder')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_weblink_channel_weblinkorderitem', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Web Link Order Item',
                'verbose_name_plural': 'Web Link Orders Items',
            },
            bases=(wagtail.search.index.Indexed, models.Model),
        ),
    ]
